                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($allWithdrawalTransaction as $transaction)
                                <tr>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Showing
                                    <span class="font-medium">{{ $allWithdrawalTransaction->firstItem() }}</span>
                                    to
                                    <span class="font-medium">{{ $allWithdrawalTransaction->lastItem() }}</span>
                                    of
                                    <span class="font-medium">{{ $allWithdrawalTransaction->total() }}</span>
                                    results
                                </p>
                            </div>
                            <div>
                                {{ $allWithdrawalTransaction->links() }}
                            </div>
                        </div>
                    </div>
                </div>
